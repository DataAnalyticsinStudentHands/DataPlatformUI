    ...
    <v-card class="mx-auto my-4 pa-4" max-width="900" elevation="2">
      ...
      <v-card-text>
        <v-form @submit.prevent="handleSubmitForm" ref="form">
          ...
          <!-- 7) ACTIVITIES & METHODOLOGY -->
          <h3 class="text-subtitle-1 mt-4 mb-2">
            7. Project Activities / Methodology
          </h3>
          <v-row>
            <v-col cols="12">
              <v-textarea
                v-model="project.activities"
          ...
          <h3 class="text-subtitle-1 mt-4 mb-2">
            11. Collaboration / Partnership Opportunities
          </h3>
          <v-row>
            <v-col cols="12">
              <v-textarea
          ...
          <h3 class="text-subtitle-1 mt-4 mb-2">
            12. Evaluation Criteria / Metrics
          </h3>
          <v-row>
            <v-col cols="12">
              <v-textarea
          ...
          <!-- 13) SUSTAINABILITY & LONG-TERM PLANS -->
          <h3 class="text-subtitle-1 mt-4 mb-2">
            13. Sustainability & Long-Term Plans
          </h3>
          <v-row>
            <v-col cols="12">
              <v-textarea
                v-model="project.sustainability"
                label="Sustainability / Long-Term Plans"
                variant="outlined"
                density="comfortable"
                rows="2"
                auto-grow
...
<!-- TAGS CHECKBOXES -->
<h3 class="text-subtitle-1 mt-4 mb-2">15. Select Tags</h3>
<v-row>
  <v-col
