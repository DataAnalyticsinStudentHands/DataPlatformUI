    ...
    <main>
      ...
      >
        <v-container>
          ...
          <v-row>
            <v-col>
              <p class="font-weight-black text-h6">{{ $t('Edit Project') }}</p>
            </v-col>
          </v-row>
          ...
          <template v-else>
            ...
            <v-row>
              <v-col cols="12" md="6">
                <p class="font-weight-black text-h8">{{ $t('Associated Instructor') }}</p>
                <v-text-field
                  v-model="projectData.instructorName"
                  :label="$t('Instructor')"
                  outlined
                  readonly
                ></v-text-field>
              ...
              <v-col cols="12" md="6">
                <p class="font-weight-black text-h8">{{ $t('Instructor Email') }}</p>
                <v-text-field
                  v-model="projectData.instructorEmail"
                  :label="$t('Email')"
                  outlined
                  readonly
                ></v-text-field>
            ...
            <!-- Project Members - Design 3: Enhanced List with Actions -->
            <v-row>
              <v-col cols="12">
                <v-sheet rounded class="pa-4 bg-grey-lighten-5">
                  <div class="d-flex justify-space-between align-center mb-3">
                    <div>
                      <p class="font-weight-black text-h6">{{ $t('Project Members') }}</p>
                      <p class="text-caption text-grey">{{ projectMembers.length }} {{ projectMembers.length === 1 ? 'person' : 'people' }} working on this project</p>
                    </div>
                    <v-btn
                      color="#c8102e"
                      variant="elevated"
                  ...
                  <div v-if="projectMembers.length === 0" class="text-center my-4 pa-6 bg-white rounded">
