              ...
              <v-card-text>
                ...
                >
                  ...
                  <template #item.actions="{ item }">
                    ...
                    <v-btn color="red-darken-2" @click="openRejectionDialog(item)">
                      Reject
                    </v-btn>
                  </template>
                </v-data-table>
              ...
              <v-card-title class="headline d-flex justify-space-between align-center">
                ...
                >
                  <span class="d-none d-md-flex">
                    ...
                    {{ selectedApprovedProjects.length === 1 ? " Project" : " Projects" }}
                  </span>
...
export default {
  ...
  data: () => ({
    ...
    pendingProjects: [
      { name: "Community Code Initiative", description: "Brings coders together for outreach." },
      { name: "Academic App Accelerator", description: "Accelerates academic app creation." },
      { name: "Tech for Tomorrow", description: "Forward-thinking tech solutions." },
      { name: "EduEngage Network", description: "Networks educational communities digitally." },
      { name: "Hack for Humanity", description: "Coding events for humanitarian challenges." },
    ],
    approvedProjects: [],
    rejectedProjects: [],
  ...
  methods: {
    handleApproval(project) {
      this.pendingProjects = this.pendingProjects.filter(p => p !== project);
    ...
    confirmRejection() {
      ...
      this.pendingProjects = this.pendingProjects.filter(p => p !== this.projectToReject);
      ...
      console.log("Rejected project:", this.projectToReject, "Reason:", this.rejectionReason);
