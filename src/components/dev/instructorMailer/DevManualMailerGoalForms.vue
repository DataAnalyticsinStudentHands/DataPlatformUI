<!--
DevManualMailerGoalForms.vue
Manual mailer form for students without goal forms. Features experience selection,
...
<div class="form-content">
  ...
  <div class="form-section">
    <div class="section-header">
      ...
      <div>
        ...
        <p class="section-subtitle">Choose an experience to find students without goal forms</p>
      </div>
    </div>
  ...
  <template v-if="studentsWithoutGoalForms && studentsWithoutGoalForms.length">
    <v-divider></v-divider>
    ...
    <div class="form-section">
      <div class="section-header">
        ...
        <div>
          ...
          <p class="section-subtitle">{{ totalStudentsCount }} students found without goal forms</p>
        </div>
      </div>

      <div class="section-content">
        <v-row>
          <!-- Left Table: Students Without Goal Form -->
          <v-col cols="12" md="5">
...
export default {
    ...
    methods: {
        ...
        async fetchStudents() {
            ...
            const user = useLoggedInUserStore();
            const token = user.token;
            const url = import.meta.env.VITE_ROOT_API + `/instructorSideData/students-without-goal-form/${this.selectedExperience}`;
