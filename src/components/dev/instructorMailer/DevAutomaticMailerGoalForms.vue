...
export default {
name: "DevAutomaticMailerGoalForms",
components: {
    ckeditor: Ckeditor
},
inject: ['setTab'],
data() {
    return {
        goalSettingFormEmail: { ...mockAutoMailerConfig.goalSettingForm },
        editorInstance: null,
...
methods: {
    ...
    applyEmailConfigs() {
        try {
            console.log('[DevMailer] Apply Goal Form Auto-Mailer config:', this.goalSettingFormEmail);
