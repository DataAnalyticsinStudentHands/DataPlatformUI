...
methods: {
    ...
    isActivityNameMatched(activityName) {
        if (!this.searchCriteria.some(criteria => criteria.category === "Activity Name")) {
            return false;
        }
        const activityNameTerms = this.searchCriteria
...
.no-activities {
    ...
    font-style: italic; /* Optional styling for 'None' */
}
