<!--
DevManualMailerEntryForms.vue
Manual mailer form for students without entry forms. Features dual-table
student selection, email composition with CKEditor, and bilingual support.
  ...
  <div class="form-section">
    <div class="section-header">
      ...
      <div>
        ...
        <p class="section-subtitle">Choose students without entry forms to email</p>
      </div>
    </div>

    <div class="section-content">
      <v-row>
        <!-- Left Table: Students Without Entry Form -->
        <v-col cols="12" md="5">
          <v-card variant="outlined" class="table-card">
            <v-card-title class="table-card-title">
              ...
              Students Without an Entry Form
            </v-card-title>
        ...
        <v-row v-else>
          <v-col cols="12" md="6">
            <div class="email-preview">
              <div class="language-badge mb-3">English</div>
              <div class="email-preview-header">
                <div class="email-preview-row">
                  <span class="email-preview-label">From:</span>
                  <span class="email-preview-value">Data Platform &lt;data.platform123@gmail.com&gt;</span>
          ...
          <v-col cols="12" md="6">
            <div class="email-preview">
              <div class="language-badge mb-3">Spanish</div>
              <div class="email-preview-header">
                <div class="email-preview-row">
                  <span class="email-preview-label">From:</span>
                  <span class="email-preview-value">Data Platform &lt;data.platform123@gmail.com&gt;</span>
