...
methods: {
    async fetchActivityData() {
        try {
            ...
            const token = `
            eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiI5NTAyYjE5MC01MDBlLTExZWUtYmIzYy04NWUwMjgxZTljOGEiLCJ1c2VyUm9sZSI6Ikluc3RydWN0b3IiLCJvcmdJRCI6IjY0ZTNiN2Y0YWY2YmFlMzZiZjQyZDUxYiIsImlhdCI6MTcwNTA4ODM5OSwiZXhwIjoxNzA1MTAwMzk5fQ.3PaKUC2o0Aej3n04E5xTHU-15xkf1jd0R5Od0X6rBfo
            `
