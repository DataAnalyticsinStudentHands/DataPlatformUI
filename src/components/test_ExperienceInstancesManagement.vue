...
methods: {
    async fetchInstances() {
        ...
        const token = `
        eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySUQiOiI5NTAyYjE5MC01MDBlLTExZWUtYmIzYy04NWUwMjgxZTljOGEiLCJ1c2VyUm9sZSI6Ikluc3RydWN0b3IiLCJvcmdJRCI6IjY0ZTNiN2Y0YWY2YmFlMzZiZjQyZDUxYiIsImlhdCI6MTcwNTE5ODE5NywiZXhwIjoxNzA1MjEwMTk3fQ.IMzA7gVQofqYFRKqQc1o7-vEZHDBa62d2j1zpV_xBlk
        `
